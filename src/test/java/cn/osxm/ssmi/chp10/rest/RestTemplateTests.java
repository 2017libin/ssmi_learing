...
public class RestTemplateTests {
	...
	public void getForObject() {
		...
		//
		/*
		 * Map<String, String> urlParams = new HashMap<>(1); urlParams.put("id",
		 * String.valueOf(1)); User user2 = restTemplate.getForObject(url, User.class,
		 * urlParams);
		 * 
		 * // 构造URL对象，要在url上进行字符串拼接，不推荐使用 int id = 1; url =
		 * "http://localhost:9000/user/" + id; User user3 =
		 * restTemplate.getForObject(URI.create(url), User.class);
